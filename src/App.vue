...
<template>
  <main class="container mx-auto">
    <header>
      <nav
        class="flex items-center justify-between flex-wrap bg-purple-500 p-6"
      >
